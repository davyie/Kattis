...
function product_entry($ar, $class='info') {//Skriver ut produkter på hemsidan. 
    ...
    <form method=POST action='".htmlentities($_SERVER['PHP_SELF'])."'><input type=submit id='add'  value='Add to Cart'/><input name='tillkundkorgen' type=hidden value='".$ar['Produktid']."'/></form>
	</div>
    </section>
    ";
}
