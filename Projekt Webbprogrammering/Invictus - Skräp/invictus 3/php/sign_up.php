...
<div>
   <a href="index.php" ><img src="../images/logo.png"/></a>
    ...
    <li class="huvudmeny"><a href="../html/contact_us.html">Contact us</a>       </li>
     <li class="huvudmeny"><a class="aktiv" href="../php/log_in.php">My Account</a>
         <ul class="drop2">
            ...
            <li class="submeny2"><a href="sign_up.php">Signup</a</li>
                        ...
                        <li class="huvudmeny"><a href="../php/kassa.php"><img src="../images/kundkorg_ikon.png"/></a></li>
            </li>
    </ul>
	</ul>
</nav>
...
if(isset($_SESSION['kundkorg'])) {} else {
	...
	if(isset($_POST['signup'])){
		...
		echo "Nu har du skapat ett konto<br />";
