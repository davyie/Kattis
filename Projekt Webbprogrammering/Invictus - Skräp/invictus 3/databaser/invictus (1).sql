...
--
-- Värd: 127.0.0.1
-- Tid vid skapande: 11 jan 2016 kl 15:36
...
CREATE TABLE `kund` (
  ...
  `usertype` varchar(128) NOT NULL DEFAULT 'customer'
...
(1, 'Drive', 'style', 'jsjsja 69', 768894066, 'Drivewithstyle@gmail.com', 'jesper', '13534', 'stockholm', 'customer'),
(2, 'Jesper', 'Eriksson', 'musse33', 768894055, 'alla@hotmail.com', 'jesper', '13534', 'stockholm', 'customer'),
(3, 'admin', 'admina', 'addads', 323323232, 'admin@gmail.com', 'admin', '13454', 'tyreso', 'admin');
...
--
-- Dumpning av Data i tabell `ordern`
--

INSERT INTO `ordern` (`orderid`, `datum`, `ordernr`, `kundid`, `summa`, `bestallt`) VALUES
(1, '2016-01-06 12:14:04', '20160106-121404', 1, 520, '3'),
(2, '2016-01-06 18:37:19', '20160106-183719', 1, 460, '1'),
(3, '2016-01-08 09:58:31', '20160108-095831', 1, 920, '1,1');
...
--
ALTER TABLE `kund`
  MODIFY `kundid` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
