...
function get_betalningssida() {
		...
		return "<h1>Click on Order to place an order</h1><form id='bestall' method=POST action=''><input type=submit value='Beställ'/><input type=hidden name='bestallninggjord'/></form>";
...
if(count($_SESSION['kundkorg'])==0) {
	return "";
		...
		if($_SESSION['access']=="admin") {
			...
			return "<section><form id='bestall1' method=POST action=''><input type=submit value='Place order'/><input type=hidden name='fragaombestallning'/></form>"
."<a href=index.php>Back to first page</a></section>";
	}
	}
