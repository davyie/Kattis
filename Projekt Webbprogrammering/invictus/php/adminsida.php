...
error_reporting(0);
//Följande kod testar ifall användaren är inloggad som admin eller inte. 
session_start();
...
//Funktionerna nedan skriver ut ren html-kod till webbläsaren. 
...
return '    
    ...
    <aside>
        <a href="visarapport.php"><h1>Report</h1></a>
    </aside>    
