...
// Här finns ren html-koder som endast skriver ut HTML. 

//Våra dropdown-menyer gjordes med hjälp av HTML och CSS. 
//Källa: http://inspirationalpixels.com/tutorials/creating-a-dropdown-menu-with-html-css 
//Ytterligare tips och tricks vi har använt oss av: 
//Källa: https://www.w3.org/Style/Examples/007/center.en.html
    ...
    <li class="huvudmeny"><a href="testlog.php">Account</a>
        <ul class="drop">
            ...
            <li class="submeny"><a href="sign_up.php">Sign up</a</li>
                        ...
                        <li class="huvudmeny"><a href="kassa.php"><img src="../images/guldkundkorg.png"/> ('.count($_SESSION['kundkorg']).')</a></li>
            </li>
    </ul>
</nav>
...
<head>
    ...
    <link rel="stylesheet" href="../css/adminrapporter.css"/>
    <link rel="stylesheet" href="../css/header.css"/>
    <link rel="stylesheet" href="../css/footer.css"/>
	<link rel="shortcut icon" href="../images/favicon.jpg" />
...
<header>
    ...
    <li class="huvudmeny"><a href="adminsida.php">My account</a>
        ...
        <li class="submeny"><a href="logout.php">Log out</a></li>
            ...
            <li class="submeny"><a href="visarapport.php">Report</a></li>
             <li class="submeny"><a href="visasummering.php">Summary</a></li>
        </ul>
...
<div>
    ...
    <li class="huvudmeny"><a href="social_media.php">Social media</a></li>
    <li class="huvudmeny"><a href="contact_us.php">Contact us</a>       </li>
     <li class="huvudmeny"><a class="aktiv" href="usersida.php">My account</a>
       <ul class="drop">
            <li class="submeny"><a href="logout.php">Log out</a></li>
                   </ul>
            </li>
...
return '
    ...
    <iframe src="https://player.vimeo.com/video/151498613?" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
    </p>
    </section>'; 
}
//autoplay=1
...
// denna script är tagen från responsiveslides.com
...
function section_usersida(){
	return "<section>
    <div>
    <img src='../images/samurai.png' alt='instagram'/>
    <aside>'Page not found, someone have been cutting the cords.
Sorry for the inconvenience.'</aside>
    </div>
</section>";
}
